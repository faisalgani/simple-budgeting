...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?php echo $current_context; ?>">Hak Akses</a></li>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-warning">
        ...
        <div class="box-body">
          ...
          <div class="col-md-10">
            <input class="form-control " name="role_name" value="<?php echo set_value('role_name', $role->role_name); ?>" placeholder="Role Name"  required  maxlength=50>
          </div>
